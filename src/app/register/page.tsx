      ...
      <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-6 xl:gap-8 xl:grid-cols-[1.2fr_1fr]">
        ...
        <section className="order-1 xl:order-2 self-center rounded-3xl border border-slate-200/80 bg-white p-6 shadow-xl shadow-slate-200/60 flex flex-col justify-between">
          {showOtp ? <div>
            ...
            <div className="mb-5"><p className="text-xs font-semibold text-blue-600">CREATE YOUR WORKSPACE</p><h2 className="mt-1.5 text-2xl font-extrabold tracking-tight text-slate-900">Get started with SKYLITE</h2><p className="mt-1.5 text-sm leading-normal text-slate-500">Set up your account now. Invite teammates and create your first project straight after.</p></div>
