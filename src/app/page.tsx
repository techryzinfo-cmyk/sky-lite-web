      ...
      <header className={`fixed inset-x-0 top-0 z-50 transition-all duration-300 ${scrolled ? 'border-b border-white/10 bg-[#07172b]/90 shadow-xl shadow-slate-950/15 backdrop-blur-xl' : 'bg-transparent'}`}>
        <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-5 sm:px-8">
          <Link href="/" className="flex items-center gap-2.5 text-xl font-bold tracking-tight text-white" aria-label="SkyStruct Lite home">
            <img src="/icon.png" alt="SkyStruct Lite" className="h-8 w-8 object-contain rounded-md" /> SKYSTRUCT<span className="text-cyan-300"> LITE</span>
          </Link>
            ...
            <div className="relative mx-auto mt-16 max-w-6xl rounded-2xl border border-white/15 bg-white/[.06] p-2 shadow-2xl shadow-black/30 backdrop-blur-sm sm:p-3">
              <div className="overflow-hidden rounded-xl bg-[#f4f8fc] p-3 sm:p-5">
                ...
                <div className="grid gap-4 lg:grid-cols-[176px_1fr]">
                  <aside className="hidden rounded-xl bg-[#0c2440] p-4 text-slate-300 lg:block"><p className="mb-7 text-sm font-bold tracking-tight text-white flex items-center gap-2"><img src="/icon.png" alt="SkyStruct Lite" className="h-5 w-5 object-contain rounded-sm" /> SKYSTRUCT<span className="text-cyan-300"> LITE</span></p>{['Overview', 'Projects', 'Workflows', 'Documents', 'Team'].map((item, index) => <div key={item} className={`mb-1 rounded-lg px-3 py-2 text-xs ${index === 0 ? 'bg-cyan-300 font-bold text-[#0c2440]' : ''}`}>{item}</div>)}<div className="mt-12 rounded-lg border border-white/10 bg-white/5 p-3"><p className="text-[10px] text-slate-400">Monthly health</p><p className="mt-1 text-xl font-bold text-white">86<span className="text-sm text-cyan-300">/100</span></p></div></aside>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-white/10 pb-12 sm:grid-cols-2 md:gap-12 lg:grid-cols-[1.5fr_repeat(3,1fr)]">
            <div className="max-w-xs">
              <Link href="/" className="flex items-center gap-2.5 text-xl font-bold tracking-tight text-white" aria-label="SkyStruct Lite home"><img src="/icon.png" alt="SkyStruct Lite" className="h-8 w-8 object-contain rounded-md" /> SKYSTRUCT<span className="text-cyan-300"> LITE</span></Link>
