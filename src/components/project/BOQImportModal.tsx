            ...
            <div className="bg-white rounded-2xl shadow-xl border border-gray-200 p-8">
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900">Import BOQ</h2>
                    <p className="text-xs text-slate-500 mt-0.5">Upload Excel (.xlsx) file to bulk import items.</p>
                  </div>
                </div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-2xl p-4 mb-8">
                <div className="flex space-x-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-blue-700">Template Instructions</p>
                    <p className="text-xs text-blue-600 mt-1">Ensure your Excel has: Group, Description, Unit, Quantity, and Rate columns.</p>
                  </div>
                </div>
              </div>

              <form onSubmit={handleSubmit} className="space-y-8">
                <label className="block border-2 border-dashed border-gray-200 hover:border-emerald-400 hover:bg-emerald-50 rounded-2xl p-10 text-center cursor-pointer transition-all group">
                  <input
                    type="file"
                    className="hidden"
                    accept=".xlsx, .xls"
                  ...
                  <div className="flex flex-col items-center">
                    <div className="p-4 rounded-full bg-gray-100 group-hover:bg-emerald-100 transition-colors mb-4">
