              ...
              <div className="p-8">
                <div className="flex items-center justify-between mb-8">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-white">Request Materials</h2>
                      <p className="text-xs text-slate-400 mt-0.5">Create a request for project supplies.</p>
                    </div>
                  </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="space-y-4 max-h-[40vh] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <button 
                      ...
                      className="w-full py-3 border-2 border-dashed border-white/10 rounded-2xl text-slate-500 hover:text-blue-400 hover:border-blue-500/50 transition-all flex items-center justify-center space-x-2 text-sm font-bold"
                    >
                  ...
                  <div className="space-y-2">
                    <label className="text-sm font-medium text-slate-300 ml-1">Common Note (Optional)</label>
