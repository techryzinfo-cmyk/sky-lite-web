...
import {
  ...
  Layers, Layout, Eye, Pencil, Trash2, SquareStack,
} from 'lucide-react';
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pagedTemplates.map((template) => {
            ...
            return (
              /*
               * FIX: Wrap in a relative div OUTSIDE GlassCard so the 3-dot dropdown
               * is positioned relative to the card wrapper, not inside the
               * overflow-hidden image div that was clipping it.
               */
              <div key={template._id} className="relative">
                <GlassCard
                  ...
                  gradient
                >
                  {/* Cover image — overflow-hidden only clips the image zoom, not the menu */}
                  <div className="h-36 relative overflow-hidden">
                    ...
                    {/* Category badge — safe inside image div (not a dropdown) */}
                  ...
                  {/* Card body */}
                  <div className="p-5">
                    <h4 className="text-base font-bold text-gray-900 group-hover:text-blue-600 transition-colors mb-1 line-clamp-1 pr-8">
                      {template.name}
                    </h4>
                ...
                {/*
                 * 3-dot menu — OUTSIDE GlassCard (which has overflow:hidden) so the
                 * dropdown panel is NEVER clipped. Positioned absolute relative to the
                 * parent wrapper div. z-50 ensures it renders above sibling cards.
                 */}
                <div
                ...
                >
                  <button
                    ...
                    className="p-1.5 rounded-lg bg-white/95 text-slate-500 hover:text-gray-900 border border-gray-200 shadow-sm transition-all backdrop-blur-md"
                    title="More options"
                  >
