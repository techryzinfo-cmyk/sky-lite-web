            ...
            <div className="bg-gradient-to-br from-blue-600 via-blue-600 to-indigo-700 px-5 sm:px-6 pt-6 pb-5 text-white">
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                {[
                  ...
                  { label: 'Total Value', value: formatCurrency(detailTotal, project?.currency || '$'), icon: DollarSign },
              ...
              <tfoot>
                <tr className="bg-gray-50 border-t-2 border-gray-200">
                  ...
                  <td className="px-4 py-3.5 text-right font-black text-gray-900 text-base">
                    {formatCurrency(detailTotal, project?.currency || '$')}
                  </td>
                  <td colSpan={2} />
                </tr>
              </tfoot>
        ...
        ─────────────────────────────────────────────────────────────────── */}
          <div className="sm:hidden space-y-3">
                ...
                <div key={item._id} className="bg-white rounded-2xl border border-gray-200 overflow-hidden shadow-sm">
                  ...
                  <div className="grid grid-cols-3 gap-px bg-gray-100">
                    {[
                      ...
                      { label: 'Unit Cost', value: formatCurrency(Number(item.unitCost), project?.currency || '$'), mono: false },
                      { label: 'Total Cost', value: formatCurrency(Number(item.totalCost || 0), project?.currency || '$'), highlight: true },
            ...
            <div className="flex items-center justify-between px-5 py-3.5 bg-gray-900 text-white rounded-2xl">
              ...
              <span className="text-lg font-black">{formatCurrency(detailTotal, project?.currency || '$')}</span>
            </div>
          </div>
                  ...
                  <tfoot>
                    <tr className="border-t-2 border-gray-200 bg-gray-50">
                      ...
                      <td className="px-5 py-3.5 text-right font-black text-gray-900 text-base">
                        {formatCurrency(filteredGroups.reduce((s, g) => s + groupedItems[g].reduce((a, i) => a + (i.totalCost || 0), 0), 0), project?.currency || '$')}
                      </td>
                      <td colSpan={4} />
                    </tr>
                  </tfoot>
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-px bg-gray-100 border-t border-gray-100">
                      ...
                      <div className="bg-white px-3 py-2.5 text-center">
                        ...
                        <p className="font-black text-xs text-blue-600">{formatCurrency(totalCost, project?.currency || '$')}</p>
                      </div>
                      <div className="bg-white px-3 py-2.5 text-center">
